...
function Home() {
  ...
  <div className="grid grid-cols-1 md:grid-cols-3">
    <div className="flex flex-col items-center md:items-start">
      <div className="flex items-center space-x-2">
        <img src={logo} alt="ELearn logo" className="w-10 h-10 rounded-full" />
        <h1 className="text-2xl text-orange-500 font-bold">ELearn</h1>
      </div>
...
>
  <FaLinkedin className="text-2xl hover:text-blue-600 duration-300" />
        ...
        <a href="https://www.instagram.com/t.ushar20/"><FaInstagram className="text-2xl hover:text-pink-600 duration-300" />
        </a>
    ...
    <div className="items-center mt-6 md:mt-0 flex flex-col">
      ...
      <ul className="space-y-2 text-gray-400">
        <li className="hover:text-white cursor-pointer duration-300">
          <a href="https://topmate.io/tusharbhardwaj" target="_blank" rel="noopener noreferrer">
            Topmate - Tushar Bhardwaj
          </a>
        </li>
        <li className="hover:text-white cursor-pointer duration-300">
          <a href="mailto:tusharbhardwaj2617@gmail.com" target="_blank" rel="noopener noreferrer">
            Gmail - tusharbhardwaj2617@gmail.com
          </a>
        </li>
        <li className="hover:text-white cursor-pointer duration-300">
          <a href="https://github.com/TuShArBhArDwA" target="_blank" rel="noopener noreferrer">
      ...
      <div className="items-center mt-6 md:mt-0 flex flex-col">
        <h3 className="text-lg font-semibold mb-4">&copy; {new Date().getFullYear()} ELearn. All rights reserved.</h3>
  ...
  <div className="mt-10 text-center text-gray-500 text-sm">
    Made with ❤️ by{" "}
    <a
      href="https://t-bot-blush.vercel.app/"
      target="_blank"
      rel="noopener noreferrer"
